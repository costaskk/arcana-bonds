...
import { RarityWeightsBase, BANNERS } from "../game/data";
...
<div className="text-center text-white text-3xl font-black drop-shadow flex items-center gap-2"><Sparkles/> OPENING GATE...</div>
)}
</div>


<div className="flex items-center gap-3 mt-4">
<Button disabled={summoning || currency < 100} onClick={async ()=>{ setSummoning(true); const pulls = await onSummon(); setSummoning(false); }}>
