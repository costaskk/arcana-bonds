...
const map = { ember:<Flame className={className}/>, aqua:<Droplets className={className}/>, gale:<Wind className={className}/>, terra:<Mountain className={className}/>, arc:<Zap className={className}/> };
